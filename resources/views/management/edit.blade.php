                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="uz" role="tabpanel"
                                            ...
                                            <input type="text" name="fname_uz" value="{{ $management->fname_uz }}"  class="form-control" required>
                                            <hr>
                                            <label for="birthday_uz">Tug'ilgan kun</label>
                                            <input type="text" name="birthday_uz"  value="{{ $management->birthday_uz }}"  class="form-control" required>
                                            <hr>
                                            <label for="education_uz">Talim</label>
                                            <input type="text" name="education_uz" value="{{ $management->education_uz }}"  class="form-control" required>
                                            <hr>
                                        ...
                                        <div class="tab-pane fade" id="kiril" role="tabpanel"
                                            ...
                                            <input type="text" name="fname_kiril" value="{{ $management->fname_kiril }}"  class="form-control">
                                            <hr>
                                            <label for="birthday_kiril">Туғилган кун</label>
                                            <input type="text" name="birthday_kiril" value="{{ $management->birthday_kiril }}" class="form-control">
                                            <hr>
                                            <label for="education_kiril">Талим</label>
                                            <input type="text" name="education_kiril" value="{{ $management->education_kiril }}"  class="form-control">
                                            <hr>
                                            <label for="work_ex_kiril">Иш Тажриба</label>
                                            <textarea class="form-control" id="editor2"   name="work_ex_kiril" >
                                                {{ $management->work_ex_kiril }}
                                            </textarea>
                                        </div>
                                        <div class="tab-pane fade" id="ru" role="tabpanel"
                                             aria-labelledby="ru">
                                            <label for="fname_ru">ФИО</label>
                                            <input type="text" name="fname_ru" value="{{ $management->fname_ru }}" class="form-control">
                                            <hr>
                                            <label for="birthday_ru">Туғилган кун</label>
                                            <input type="text" name="birthday_ru" value="{{ $management->birthday_ru }}"  class="form-control">
                                            <hr>
                                            <label for="education_ru">Талим</label>
                                            <input type="text" name="education_ru" value="{{ $management->education_ru }}"  class="form-control">
                                            <hr>
                                            <label for="work_ex_ru">Иш Тажриба</label>
                                            <textarea class="form-control" id="editor3"  name="work_ex_ru" >
                                                {{ $management->work_ex_ru }}
                                            </textarea>
                                        </div>
                                        <div class="tab-pane fade" id="en" role="tabpanel"
                                             aria-labelledby="en">
                                            <label for="fname_en">Full name</label>
                                            <input type="text" name="fname_en"  value="{{ $management->fname_en }}" class="form-control">
                                            <hr>
                                            <label for="">Birthday</label>
                                            <input type="text" name="birthday_en" value="{{ $management->birthday_en }}"  class="form-control">
                                            <hr>
                                            <label for="education_en">Education</label>
                                            <input type="text" name="education_en" value="{{ $management->education_en }}"  class="form-control">
                                            <hr>
                                            <label for="work_ex_en">Work Experience</label>
                                            <textarea class="form-control" id="editor4"  name="work_ex_en" required>
                                                {{ $management->work_ex_en }}
                                            </textarea>
                                        </div>
                                    </div>
